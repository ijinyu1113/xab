...
To address these challenges, I developed a deep learning model, combining *EfficientNet* [Tan et al, 2019] and *cost-sensitive learning* [Lin et al, 2017]. The model showed over 94% f1-score on VinBigData. I also applied *model calibration* [Guo et al, 2017] to accurately estimate the prediction confidence. I submitted a student-track paper to AMIA 2023 Informatics Summit.

Accurately diagnosing lung diseases without doctors’ presence is hard and dangerous, because the diagnosis itself is difficult and taking responsibility for a misdiagnosis is complicated. This prescreening model can relieve these two problems and save money by reducing espensive doctors' labor costs.
